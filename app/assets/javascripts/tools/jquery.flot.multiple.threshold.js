...
usage -
  ...
  where constraint1 = {
        ...
        label     -> new label of the subset (null meaning old label) 
...
(function($){
  ...
  function init(plot){
    ...
    function Resolve(originalPoints) {
                ...
                function showBars() {
                        if (plot.getOptions().series.bars.show) {
                                ...
                                for (var i = 0; i < allData.length; i++) {
                                        if (allData[i].data == originalPoints) {
                                                return allData[i].bars.show;
                                        }
                                }
                        }
                        return false;
                ...
                function using(threshold, evaluate) {
                        ...
                        for ( var i = 0; i < this._originalPoints.length; i++) {
                                ...
                                if (evaluate(currentPoint[1],threshold)) {
                                        if (!this.showBars && i > 0 && (this._data.length == 0 || this._data[count - 1] == null)) {
